...
import static gui.resultpanel.RiskCombinationsNameMap.*;

public class RiskCombinationsTableModel extends AbstractTableModel {
    ...
    public RiskCombinationsTableModel(@NotNull String[] header, @NotNull List<DreamTeam> dreamTeams) {
        columnNames = header;
        ...
        for (DreamTeam dreamTeam : dreamTeams) {
            ...
            data[fieldIndex][MIN_POINTS.ordinal()] = String.format(DOUBLE_FORMAT, dreamTeam.getPoints());
            data[fieldIndex][MAX_PRICE_CHANGE.ordinal()] = String.format(DOUBLE_FORMAT, dreamTeam.getPriceChange());
